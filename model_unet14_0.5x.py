...
def build_model():
    ...
    conv7 = vgg_block(2048, 2, pool6)

    up8 = Conv2DTranspose(1024, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv7)
    up8 = BatchNormalization()(up8)
    up8 = Activation('relu')(up8)
    up8 = concatenate([up8, conv6], axis=3)
    conv8 = vgg_block(1024, 2, up8)
    up9 = Conv2DTranspose(512, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv8)
    up9 = BatchNormalization()(up9)
    up9 = Activation('relu')(up9)
    up9 = concatenate([up9, conv5], axis=3)
    conv9 = vgg_block(512, 2, up9)
    up10 = Conv2DTranspose(256, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv9)
    up10 = BatchNormalization()(up10)
    up10 = Activation('relu')(up10)
    up10 = concatenate([up10, conv4], axis=3)
    conv10 = vgg_block(256, 2, up10)
    up11 = Conv2DTranspose(128, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv10)
    up11 = BatchNormalization()(up11)
    up11 = Activation('relu')(up11)
    up11 = concatenate([up11, conv3], axis=3)
    conv11 = vgg_block(128, 2, up11)
    up12 = Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv11)
    up12 = BatchNormalization()(up12)
    up12 = Activation('relu')(up12)
    up12 = concatenate([up12, conv2], axis=3)
    conv12 = vgg_block(64, 2, up12)
    up13 = Conv2DTranspose(32, (3, 3), strides=(2, 2), padding='same', kernel_initializer=he_uniform())(conv12)
    up13 = BatchNormalization()(up13)
    up13 = Activation('relu')(up13)
    up13 = concatenate([up13, conv1], axis=3)
    conv13 = vgg_block(32, 2, up13)

    outputs = Conv2D(1, (1, 1), activation='sigmoid', kernel_initializer=he_uniform())(conv13)
...
def pseudo_train(model_name, prms, pseudo_gt_dir):
    ...
    model = build_model()
    load_model(os.path.join('model', model_name, 'model.hdf5'),
...
def main():
    ...
    train(prms)
    #valid('unet14_0.5x', pseudo=True)
    pseudo_labeling('unet14_0.5x')
    pseudo_train('unet14_0.5x', prms, 'processed/unet14_0.5x_pseudo_label')
    test('unet14_0.5x', pseudo=True)
