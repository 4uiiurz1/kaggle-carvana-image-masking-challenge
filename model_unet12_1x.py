...
from package.optimizers_accum import AdamAccum
...
def build_model():
    inputs = Input(shape=(1280, 1920, 3))
...
def train(prms):
    ...
    elif prms['optimizer'] == 'AdamAccum':
        optimizer = AdamAccum(lr=1e-4)
...
def main():
    ...
    train(prms)
    #valid('unet12_1x', pseudo=True)
    pseudo_labeling('unet12_1x')
    pseudo_train('unet12_1x', prms, 'unet12_1x_pseudo_label')
    test('unet12_1x', pseudo=True)
